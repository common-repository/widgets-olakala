...
class Widgets_Olakala_Widget_Score extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			'classname' => 'widget-olakala-score',
			'description' => 'Affiche la note moyenne globale de l’hôtel et le nombre d’avis',
		);
		parent::__construct( 'widget-olakala-score', 'Olakala Score', $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
            ...
            if ( ! empty( $instance['code'] ) ) {
                ...
                $url = OLAKALA_API_SCORE_URL.$olakalaCode;
                ?>
                <script>var $ = jQuery.noConflict();</script>
                <div class="olakala-score">
...
add_action( 'widgets_init', function(){
    register_widget( 'Widgets_Olakala_Widget_Score' );
});